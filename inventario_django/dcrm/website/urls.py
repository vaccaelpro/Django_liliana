...
urlpatterns = [
    ...
    path('admin-dashboard/usuarios/exportar-pdf/', views.export_users_pdf, name='export_users_pdf'),
    ...
    path('admin-dashboard/logs/exportar-pdf/', views.export_logs_pdf, name='export_logs_pdf'),
